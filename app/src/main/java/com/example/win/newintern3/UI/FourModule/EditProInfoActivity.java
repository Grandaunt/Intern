...
public class EditProInfoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    //0是编辑，1是添加
    private int type = 0;
    private ExperienceProject internEntity;
...
//        type = getIntent().getIntExtra("type", 0);
    ...
    private void setinfo(){
        name.setText(internEntity.getProjectName());
        post.setText(internEntity.getProjectPost());
        starttime.setText(internEntity.getProjectStartTime()+" 开始");
        endtime.setText(internEntity.getProjectEndTime()+" 结束");
        des.setText(internEntity.getProjectDes());
...
//        add.setOnClickListener(this);
    ...
    public void getData() {;
        if (getIntent().getSerializableExtra(EditProListActivity.intenttag1)!= null) {
            internEntity = (ExperienceProject) getIntent().getSerializableExtra(EditProListActivity.intenttag1);
            setinfo();
            type = 0;
        }
        else {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.edit_apei_starttime:
                ...
                new YMDatePickerDialog(EditProInfoActivity.this, 0, new YMDatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            case R.id.btn_apei_del:
                RequestParams params = new RequestParams(URLConfig.DelPorErAPI);
                params.addParameter("projectId", internEntity.getProjectId());
                Logger.d(params);
                x.http().post(params, new Callback.CommonCallback<String>() {
                    ...
                    public void onSuccess(String result) {
                        ...
                        if (code.getCode().equals("200")) {
                            ...
                            Toast.makeText(EditProInfoActivity.this, "操作失败", Toast.LENGTH_SHORT).show();
                        }
            ...
            case R.id.text_save:
                if(type == 0) {
                    if (check()) {
                        //编辑
                        RequestParams params2 = new RequestParams(URLConfig.AddProErAPI);
                        params2.addParameter("userId", application.getUserid());
                        params2.addParameter("projectId", internEntity.getProjectId());
                        params2.addParameter("projectName", name.getText().toString().trim());
                        params2.addParameter("projectPost", post.getText().toString().trim());
                        params2.addParameter("projectStartTime", starttime.getText().toString().trim());
                        params2.addParameter("projectEndTime", endtime.getText().toString().trim());
                        params2.addParameter("projectDes", des.getText().toString().trim());
                        ...
                        x.http().post(params2, new Callback.CommonCallback<String>() {
                            ...
                            public void onSuccess(String result) {
                                ...
                                if (code.getCode().equals("200")) {
//                                    setResult(1004);
                                    Toast.makeText(EditProInfoActivity.this, "修改成功", Toast.LENGTH_SHORT).show();
                                    finish();
                                } else {
                                    Toast.makeText(EditProInfoActivity.this, "操作失败", Toast.LENGTH_SHORT).show();
                                }
                    ...
                    if(check()) {
                        ...
                        x.http().post(params2, new Callback.CommonCallback<String>() {
                            ...
                            public void onSuccess(String result) {
                                ...
                                if (code.getCode().equals("200")) {
//                                        setResult(1004);
                                    Toast.makeText(EditProInfoActivity.this, "添加成功", Toast.LENGTH_SHORT).show();
                                    finish();
                                } else {
                                    Toast.makeText(EditProInfoActivity.this, "操作失败", Toast.LENGTH_SHORT).show();
                                }
    ...
    private boolean check() {
        if (name.getText().length() > 0) {
            ...
            Toast.makeText(EditProInfoActivity.this, "信息不能为空", Toast.LENGTH_SHORT).show();
            return false;
        }
