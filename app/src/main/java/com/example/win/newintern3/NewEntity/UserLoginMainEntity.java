...
public class UserLoginMainEntity implements Serializable {
    public UserLoginMainEntity() {

    }

    public UserLoginMainEntity(UserLogin userLogin, UserPractice userPracticeInfo, String isHasUserPractice) {
