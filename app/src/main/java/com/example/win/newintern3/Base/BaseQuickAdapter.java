...
import com.example.win.newintern3.Base.animation.AlphaInAnimation;
import com.example.win.newintern3.Base.animation.BaseAnimation;
import com.example.win.newintern3.Base.animation.ScaleInAnimation;
import com.example.win.newintern3.Base.animation.SlideInBottomAnimation;
import com.example.win.newintern3.Base.animation.SlideInLeftAnimation;
import com.example.win.newintern3.Base.animation.SlideInRightAnimation;
import com.example.win.newintern3.Base.callback.ItemDragAndSwipeCallback;
import com.example.win.newintern3.Base.listener.OnItemDragListener;
import com.example.win.newintern3.Base.listener.OnItemSwipeListener;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int positions) {
        ...
        switch (viewType) {
            ...
            default:
                convert((BaseViewHolder) holder, mData.get(holder.getLayoutPosition() - getHeaderViewsCount()),positions);
                onBindDefViewHolder((BaseViewHolder) holder, mData.get(holder.getLayoutPosition() - getHeaderViewsCount()),positions);
                break;
        }
    ...
    private void initItemClickListener(final BaseViewHolder baseViewHolder) {
        if (onRecyclerViewItemClickListener != null) {
            baseViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onRecyclerViewItemClickListener.onItemClick(v, baseViewHolder.getLayoutPosition() - getHeaderViewsCount(),mData.get(baseViewHolder.getLayoutPosition() - getHeaderViewsCount()));
                }
            });
        }
     ...
     */
    @Deprecated
    protected void onBindDefViewHolder(BaseViewHolder holder, T item , int pos) {
    }
     ...
     */
    protected abstract void convert(BaseViewHolder helper, T item ,int pos);
