 ...
 * 出差列表
 */
public class BusinessTripListActivity  extends AppCompatActivity implements View.OnClickListener, BaseQuickAdapter.RequestLoadMoreListener{
...
//        setSupportActionBar(toolbar);
        ...
        adapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener<LeaveInfo>() {
            ...
            public void onItemClick(View view, int position, LeaveInfo item) {
                intent = new Intent(BusinessTripListActivity.this, BusinessTripInfoActivity.class);
                intent.putExtra(BusinessTripInfoActivity.intenttag1, item);
    ...
    private void getdata() {
        RequestParams params = new RequestParams(URLConfig.BudinessListAPI);
